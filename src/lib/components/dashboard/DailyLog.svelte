...
>
	<div class="p-6">
		...
		{#if loading}
			<!-- Skeleton Loading for Already Submitted Message -->
								...
								<div class="dark:border-gray-700">
									<div class="mt-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
										...
										<div class="sm:col-span-3">
											...
											></div>
											<div
												class="mt-2 h-10 animate-pulse rounded bg-gray-200 dark:bg-gray-700"
											></div>
										</div>

										<!-- Bodyfat Input Skeleton -->
										<div class="sm:col-span-3">
											<div
												class="h-4 w-1/2 animate-pulse rounded bg-gray-200 dark:bg-gray-700"
											></div>
										...
										<!-- Progress Picture Skeleton -->
										<div class="col-span-full">
											<div
												class="h-4 w-1/2 animate-pulse rounded bg-gray-200 dark:bg-gray-700"
											></div>
											<div
												class="mt-2 h-32 animate-pulse rounded-lg bg-gray-200 dark:bg-gray-700"
											></div>
										</div>
									</div>
								</div>
